...
export const techStack = {
  frontend: [
    ...
    { name: "Astro 6", description: "Static site framework for content-focused websites", category: "Frontend", logo: "https://astro.build/assets/press/astro-icon-light-gradient.svg" },
    { name: "Astro Components", description: "Component-based static site development", category: "Frontend", logo: "https://astro.build/assets/press/astro-icon-light-gradient.svg" },
    { name: "Astro Assets", description: "Optimized image pipeline for static websites", category: "Frontend", logo: "https://astro.build/assets/press/astro-icon-light-gradient.svg" },
    ...
    { name: "CSS", description: "Global CSS and component-scoped styles", category: "Frontend", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" },
  ...
  contentSeo: [
    { name: "Static Site Generation", description: "Pre-rendered pages for fast content websites", category: "Content / SEO", logo: "" },
    { name: "Pagefind", description: "Static site search with default UI", category: "Content / SEO", logo: "" },
    { name: "WordPress REST API", description: "Build-time content fetching", category: "Content / SEO", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/wordpress/wordpress-plain.svg" },
    { name: "WordPress CMS", description: "Blog and content management", category: "Content / SEO", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/wordpress/wordpress-plain.svg" },
    { name: "JSON-LD Schema", description: "Structured data for SEO", category: "Content / SEO", logo: "" },
    { name: "@astrojs/sitemap", description: "Sitemap generation for Astro sites", category: "Content / SEO", logo: "https://astro.build/assets/press/astro-icon-light-gradient.svg" },
    { name: "Meta Tags", description: "Page-level SEO metadata", category: "Content / SEO", logo: "" }
  ],
  aiRag: [
...
export const companyInfo = {
  ...
  founded: "2023",
  incorporationDate: "Sept 27, 2023",
  incorporationDateShort: "Incorporated Sept 27, 2023",
  location: "Village Narghor (Chobu), Post Office Nagehar, Baijnath, Kangra, Himachal Pradesh 176128",
  xHandle: "@globistaan",
...
export const projects = [
  {
    ...
    status: "Demo",
    website: "https://www.dailogue.io/",
    demoVideo: "https://demo.arcade.software/video/IBey5cVTXrvgyiTpKPue?embed&autoplay=true&muted=true&mute=true&playsinline=true",
  ...
  },
  {
    ...
    demoVideo: "https://demo.arcade.software/video/bHXj6MbshFn00lBa0urm?embed&autoplay=true&muted=true&mute=true&playsinline=true",
